...
<div class="sm:mx-auto sm:w-full sm:max-w-md">
    <h2 class="text-3xl font-extrabold text-gray-900 text-center mb-2 tracking-tight">Sign In</h2>
    <p class="text-sm text-center text-gray-500 mb-8">Welcome back! Please enter your details.</p>
</div>
...
<p class="text-sm text-center text-gray-600 mt-8">
    Don't have an account? <a href="{{route('register.page')}}" class="text-blue-600 hover:text-blue-700 hover:underline font-semibold transition">Sign up</a>
</p>
@endsection
